...
ALLOWED_HOSTS = []  # Update for production (e.g., ['localhost', 'yourdomain.com'])
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Simplified using Path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGOUT_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = 'home'  # Added for better user experience
...
# Security enhancements (optional for production)
SECURE_BROWSER_XSS_FILTER = True
X_FRAME_OPTIONS = 'DENY'
SECURE_CONTENT_TYPE_NOSNIFF = True
# SECURE_SSL_REDIRECT = True  # Uncomment in production with HTTPS
